...
<body>
  ...
  <div>
    <a href="./index.php?search=<?php echo $search ?? '' ?>&order=asc">新しい順</a>
    <a href="./index.php?search=<?php echo $search ?? '' ?>&order=desc">古い順</a>
  </div>
    ...
    <div class="row justify-content-center">
      <table class="table">
        <tr>
          ...
          <!-- <th><a href="edit_form.php?id=<?php echo $blog['user_id']; ?>">編集</a></th> -->
          <th><a href="detail.php?id=<?php echo $blog['id']; ?>">詳細</a></th>
          <!-- <th><a href="delete.php?id=<?php echo $blog['user_id']; ?>">削除</a></th> -->
        </tr>
      </table>
    </div>
  <?php endforeach; ?>
